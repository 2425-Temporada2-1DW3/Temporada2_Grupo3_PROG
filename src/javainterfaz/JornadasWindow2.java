...
public class JornadasWindow2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JornadasWindow2 frame = new JornadasWindow2();
	...
	public JornadasWindow2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int opcion =  JOptionPane.showConfirmDialog(JornadasWindow2.this, "¿Está seguro que desea cerrar sesión?", "Info",  JOptionPane.YES_NO_CANCEL_OPTION);
				switch (opcion) {

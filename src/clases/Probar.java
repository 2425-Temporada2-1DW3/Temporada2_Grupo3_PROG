...
public class Probar {
    public static void main(String[] args) {
        // Crear equipos
        Equipo equipo1 = new Equipo("Real Madrid", "1902", "Madrid", new ArrayList<>(), 0);
        Equipo equipo2 = new Equipo("Barcelona", "1899", "Barcelona", new ArrayList<>(), 0);
        Equipo equipo3 = new Equipo("Atletico Madrid", "1903", "Madrid", new ArrayList<>(), 0);
        Equipo equipo4 = new Equipo("Valencia", "1919", "Valencia", new ArrayList<>(), 0);
        Equipo equipo5 = new Equipo("Sevilla", "1905", "Sevilla", new ArrayList<>(), 0);
        Equipo equipo6 = new Equipo("Betis", "1907", "Sevilla", new ArrayList<>(), 0);
